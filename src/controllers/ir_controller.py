...
class IRMAC(BasicMAC):
    def __init__(self, scheme, groups, args):
        super(IRMAC, self).__init__(scheme, groups, args)
    ...
    def _build_inputs(self, batch, t):
        ...
        # inverse matrix of rotation matrix for move action
        inverse_move_matrix = None
        if "inverse_matrix" in batch.data.transition_data.keys():
            inverse_move_matrix = batch["inverse_matrix"]
        ...
        return bs, own_context, enemy_feats_t, ally_feats_t, embedding_indices, inverse_move_matrix
