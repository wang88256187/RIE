...
class HPNS_RNNAgent(nn.Module):
    ...
    def forward(self, inputs, hidden_state):
        # [bs, n_agents, mv_fea_dim (5)], [bs * n_agents * n_enemies, enemy_fea_dim], [bs * n_agents * n_allies, ally_fea_dim], [bs, n_agents, own_fea_dim]
        ...
        hh = self.rnn(x, h_in)  # [bs * n_agents, rnn_hidden_dim] 这里就是所谓的置换不变特征
